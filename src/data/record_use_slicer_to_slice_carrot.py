...
REPO_ID = "sangam-101/so101-slicer-to-slice-carrot"
TASK_DESCRIPTION = "pick slicer from stand, slice carrot and return it"
NUM_EPISODES = 50
EPISODE_TIME_SEC = 40
RESET_TIME_SEC = 10
...
init_rerun(session_name="record_use_slicer")
